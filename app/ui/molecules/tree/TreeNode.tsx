  ...
  return (
    <>
      <div className="group relative">
        {/* barre verticale */}
        <div className="absolute shadow-indigo-500 shadow-lg left-[calc(50%-10px)] top-0 w-[20px] h-full group-[:nth-last-child(2)]:h-1/2 bg-gradient-to-r from-black via-grayMedium to-black"></div>
        {/* barre horiz */}
